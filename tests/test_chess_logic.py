...
class TestChessLogic(unittest.TestCase):
    def test_is_check(self):
        ...
        test_board = board.Board.instantiate_from_fen("./game/game_states/test_check.fen")
    ...
    def test_is_checkmate(self):
        ...
        test_board = board.Board.instantiate_from_fen("./game/game_states/test_checkmate.fen")
    ...
    def test_is_king_in_check_after_move(self):
        ...
        self.assertFalse(chess_logic.is_king_in_check_after_move(test_board, test_board.get_piece_at_square((1, 7)), (0, 7)))
        ...
        self.assertTrue(chess_logic.is_king_in_check_after_move(test_board, test_board.get_piece_at_square((0, 2)), (1, 2)))

    def test_is_stalemate(self):
        test_board = board.Board.instantiate_from_fen("./game/game_states/test_stalemate.fen")
    ...
    def test_is_legal_move(self):
        ...
        self.assertTrue(chess_logic.is_legal_move(test_board, test_board.get_piece_at_square((0, 0)), (5, 0)))
        ...
        self.assertFalse(chess_logic.is_legal_move(test_board, test_board.get_piece_at_square((0, 0)), (5, 0)))
        ...
        self.assertFalse(chess_logic.is_legal_move(test_board, test_board.get_piece_at_square((5, 0)), (4, 2)))

        test_board._remove_piece_at_square((4, 2))
        test_board._place_piece(pieces.Knight("black", (4, 2)))
        self.assertTrue(chess_logic.is_legal_move(test_board, test_board.get_piece_at_square((5, 0)), (4, 2)))
        
        # Test when the path is blocked by a piece of the same color

        # Vertically
        self.assertFalse(chess_logic.is_legal_move(test_board, test_board.get_piece_at_square((0, 0)), (7, 0)))
        # Horizontally
        test_board._place_piece(pieces.Rook("white", (0, 1)))
        self.assertFalse(chess_logic.is_legal_move(test_board, test_board.get_piece_at_square((0, 0)), (0, 7)))
        # Diagonally
        test_board._place_piece(pieces.Bishop("white", (1, 1)))
        test_board._place_piece(pieces.Bishop("white", (4, 4)))
        self.assertFalse(chess_logic.is_legal_move(test_board, test_board.get_piece_at_square((1, 1)), (7, 7)))
        self.assertTrue(chess_logic.is_legal_move(test_board, test_board.get_piece_at_square((1, 1)), (3, 3)))
